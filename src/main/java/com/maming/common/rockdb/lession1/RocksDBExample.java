package com.maming.common.rockdb.lession1;
...
/**
 * 参见 https://github.com/sxpujs/java-example/blob/master/src/main/java/com/demo/rocksdb/RocksDBExample.java
 * 
 * 需要安装rockdb,因此该类不能直接跑通
 */
